	...
	<section class="background-radial-gradient overflow-hidden">
		<div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
			<div class="row gx-lg-5 align-items-center mb-5">
                ...
                <h2 style="color:white">UPDATE DATA PETUGAS</h2>
			<div class="col mb-5 mb-lg-0 position-relative">
				...
				<div class="loginbox bg-glass">
					...
					while($d = mysqli_fetch_array($data)){
						?>
						<form method="post" action="update4_petugas.php">
							<table class="table">
								<tr>			
									<td>Nama</td>
									<td>
										<input type="hidden" name="id_petugas" value="<?php echo $d['id_petugas']; ?>">
										<input class="form-control color" type="text" name="nama" value="<?php echo $d['nama']; ?>" required>
									</td>
								</tr>
                                <tr>
                                    <td>Jenis Kelamin</td>
                                ...
                                <tr>
                                    <td>Telepon</td>
                                    <td><input class="form-control color" type="text" name="tlp" value="<?php echo $d['tlp']; ?>" required/></td>
                                </tr>
                                <tr>
                                    <td>Status</td>
                                    <td>
                                        <select class="form-control" name="status" value="<?php echo $d['status']; ?>" required>
