	...
	<section class="background-radial-gradient overflow-hidden">
		<div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
			<div class="row gx-lg-5 align-items-center mb-5">
                ...
                <h2 style="color:white">UPDATE DATA WILAYAH</h2>
			<div class="col mb-5 mb-lg-0 position-relative">
				...
				<div class="loginbox bg-glass">
					...
					$id = $_GET['id'];
					$data = mysqli_query($koneksi,"select * from wilayah where id_wilayah ='$id'");
					while($d = mysqli_fetch_array($data)){
						?>
						<form method="post" action="update4_wilayah.php">
							<table class="table">
                                <tr>			
									<td>ID Wilayah</td>
									<td>
										<input type="hidden" name="id_wilayah" value="<?php echo $d['id_wilayah']; ?>">
										<input class="form-control color" type="text" name="id_wilayah" value="<?php echo $d['id_wilayah']; ?>" required>
									</td>
								</tr>
                                <tr>
                                    <td>Nama Wilayah</td>
                                    <td><input class="form-control color" type="text" name="nama_wilayah" value="<?php echo $d['nama_wilayah']; ?>" required></td>
                                </tr>	
                                <tr>
                                    <td>Keterangan</td>
