    ...
    <section class="background-radial-gradient overflow-hidden">
      <div class="table-main px-4 py-5 px-md-5 text-center text-lg-start my-5">
        <div class="row gx-lg-5 align-items-center mb-5">
          ...
          <h2 style="color:white">DAFTAR INFORMASI TARIF</h2>
        <div class="col mb-5 mb-lg-0 position-relative">
            ...
            <div class="loginbox bg-glass">
              ...
              <form class="px-4 py-5 px-md-5" method="POST" action="tambah4_tarif.php">
            ...
            <!-- MASUKINNYA fname lname atau nama depan nama belakang? -->
                            ...
                            <td><?php echo $d['kode_tarif']; ?></td>
                            <td><?php echo $d['tarif_0_10_m3']; ?></td>
                            <td><?php echo $d['tarif_11_20_m3']; ?></td>
                            <td><?php echo $d['tarif_21_30_m3']; ?></td>
                            <td><?php echo $d['tarif_31_dst_m3']; ?></td>
                            <td><?php echo $d['keterangan']; ?></td>
                            <td style="width: 185px">
            <!-- ubah.php hapus.php nanti belakangan aja -->
                                <a role ="button" class="btn btn-ubah two" href="ubah4_tarif.php?id=<?php echo $d['id_gol']; ?>">UBAH</a> </button>
                                <a role ="button" class="btn btn-hapus three" href="hapus4_tarif.php?id=<?php echo $d['id_gol']; ?>">HAPUS</a>
                            </td>
                        </tr>
                        <?php 
                    }
