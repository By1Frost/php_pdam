    ...
    <section class="background-radial-gradient overflow-hidden">
      <div class="table-main px-4 py-5 px-md-5 text-center text-lg-start my-5">
        <div class="row gx-lg-5 align-items-center mb-5">
          ...
          <h2 style="color:white">DAFTAR INFORMASI WILAYAH</h2>
        <div class="col mb-5 mb-lg-0 position-relative">
            ...
            <div class="loginbox bg-glass">
              ...
              <form class="px-4 py-5 px-md-5" method="POST" action="tambah4_wilayah.php">
            ...
            <!-- MASUKINNYA fname lname atau nama depan nama belakang? -->
                            <td style="width: 120px"><?php echo $d['id_wilayah']; ?></td>
                            <td><?php echo $d['nama_wilayah']; ?></td>
                            <td><?php echo $d['keterangan']; ?></td>
                            <td style="width: 185px">
            <!-- ubah.php hapus.php nanti belakangan aja -->
                                <a role ="button" class="btn btn-ubah two" href="ubah4_wilayah.php?id=<?php echo $d['id_wilayah']; ?>">UBAH</a> </button>
                                <a role ="button" class="btn btn-hapus three" href="hapus4_wilayah.php?id=<?php echo $d['id_wilayah']; ?>">HAPUS</a>
                            </td>
                        </tr>
                        <?php 
                    }
