    ...
    <section class="background-radial-gradient overflow-hidden">
      <div class="table-main px-4 py-5 px-md-5 text-center text-lg-start my-5">
        <div class="row gx-lg-5 align-items-center mb-5">
          ...
          <h2 style="color:white">DAFTAR INFORMASI PELANGGAN</h2>
        <div class="col mb-5 mb-lg-0 position-relative">
            ...
            <div class="loginbox bg-glass">
              ...
              <form class="px-4 py-5 px-md-5" method="POST" action="tambah4_pelanggan.php">
            ...
            <!-- MASUKINNYA fname lname atau nama depan nama belakang? -->
                            <td style="width: 100px"><?php echo $d['no_pelanggan']; ?></td>
                            <td style="width: 150px"><?php echo $d['nama']; ?></td>
                            <td style="width: 100px"><?php echo $d['jenis_kelamin']; ?></td>
                            <td><?php echo $d['id_gol']; ?></td>
                            <td style="width: 115px"><?php echo $d['no_rek']; ?></td>   
                            <td><?php echo $d['alamat']; ?></td>
                            <td style="width: 140px"><?php echo $d['tlp']; ?></td>
                            <td style="width: 85px"><?php echo $d['id_wilayah']; ?></td>
                            <td style="width: 125px"><?php echo $d['tgl_reg']; ?></td>
                            <td><?php echo $d['status']; ?></td>
                            
                            <td>
            <!-- ubah.php hapus.php nanti belakangan aja -->
                                <a role ="button" class="btn btn-ubah two" href="ubah4_pelanggan.php?id=<?php echo $d['no_pelanggan']; ?>">UBAH</a> </button>
                                <br/>
                                <a role ="button" class="btn btn-hapus three" href="hapus4_pelanggan.php?id=<?php echo $d['no_pelanggan']; ?>">HAPUS</a>
                            </td>
                        </tr>
                        <?php 
                    }
