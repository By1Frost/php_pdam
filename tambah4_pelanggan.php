    ...
    <section class="background-radial-gradient overflow-hidden">
      <div class="table-main px-4 py-5 px-md-5 text-center text-lg-start my-5">
        <div class="row gx-lg-5 align-items-center mb-5">
          ...
          <h2 style="color:white">TAMBAH DATA PELANGGAN</h2>
              ...
              <div class="px-4 py-5 px-md-5">
                    <form method="post" action="tambahuser4_pelanggan.php">
                      <table class="table">
                        ...
                        <tr>
                          <td>No. Rekening</td>
                          <td><input class="form-control color" type="text" name="no_rek" placeholder="Masukan no. rek" required/></td>
                        </tr>
                        <tr>
                          <td>Alamat</td>
                          <td><input class="form-control color" type="text" name="alamat" placeholder="Masukan alamat" required/></td>
                        </tr>
                        <tr>
                          <td>Telepon</td>
                        ...
                        <tr>
                          ...
                          <td><input class="form-control color" type="date" name="tgl_reg" placeholder="-- Masukan tanggal --" required/></td>
                        </tr>
                        <tr>
                          <td>Jenis Kelamin</td>
                          <td>
