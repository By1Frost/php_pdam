    ...
    <section class="background-radial-gradient overflow-hidden">
      <div class="table-main px-4 py-5 px-md-5 text-center text-lg-start my-5">
        <div class="row gx-lg-5 align-items-center mb-5">
          ...
          <h2 style="color:white">DAFTAR INFORMASI PETUGAS</h2>
        <div class="col mb-5 mb-lg-0 position-relative">
            ...
            <div class="loginbox bg-glass">
              ...
              <form class="px-4 py-5 px-md-5" method="POST" action="tambah4_petugas.php">
            ...
            <!-- MASUKINNYA fname lname atau nama depan nama belakang? -->
                            <td style="width: 100px"><?php echo $d['id_petugas']; ?></td>
            ...
            <!-- ubah.php hapus.php nanti belakangan aja -->
                                <a role ="button" class="btn btn-ubah two" href="ubah4_petugas.php?id=<?php echo $d['id_petugas']; ?>">UBAH</a> </button>
                                <br/>
                                <a role ="button" class="btn btn-hapus three" href="hapus4_petugas.php?id=<?php echo $d['id_petugas']; ?>">HAPUS</a>
                            </td>
                        </tr>
                        <?php 
                    }
