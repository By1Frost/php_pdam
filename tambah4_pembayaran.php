        ...
        <div class="col mb-5 mb-lg-0 position-relative">
            ...
            <div class="loginbox bg-glass">
              ...
              <div class="px-4 py-5 px-md-5">
                  <form method="post" action="tambahuser4_pembayaran.php">
                      <table class="table">
                          <!-- MASUKINNYA fname lname atau nama depan nama belakang? -->
                            <tr>
                            <td>ID. Tagihan</td>
                              <td>
                                  <select class="form-control color" name="id_tagihan" required>
                            ...
                            <tr>
                                <td>Tanggal Bayar</td>
                                <td><input class="form-control color" type="date" name="tgl_bayar" placeholder="Masukan Tanggal Bayar" required></td>
                            </tr>	
                            <tr>
                                <td>Jumlah Bayar</td>
                                <td><input class="form-control color" type="text" name="jml_bayar" placeholder="Masukan Jumlah Bayar" required></td>
                            </tr>
                            <tr>
